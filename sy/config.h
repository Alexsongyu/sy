...
namespace sy
{
    ...
    public:
        ...
        typedef std::shared_ptr<ConfigVar> ptr; // 定义智能指针类
    ...
    public:
        ...
        // 创建对应参数名的配置参数：name 配置参数名称、default_value 参数默认值、description 参数描述
        template <class T>
