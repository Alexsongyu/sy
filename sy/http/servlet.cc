...
int32_t FunctionServlet::handle(sy::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("sy/1.0"));
}

int32_t ServletDispatch::handle(sy::http::HttpRequest::ptr request
               , sy::http::HttpResponse::ptr response
               , sy::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(sy::http::HttpRequest::ptr request
                   , sy::http::HttpResponse::ptr response
                   , sy::http::HttpSession::ptr session) {
    response->setStatus(sy::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "sy/1.0.0");
