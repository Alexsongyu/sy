 ...
 */
#ifndef __SY_HTTP_SERVLET_H__
#define __SY_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(sy::http::HttpRequest::ptr request
                   ...
                   , sy::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (sy::http::HttpRequest::ptr request
                   , sy::http::HttpResponse::ptr response
                   , sy::http::HttpSession::ptr session)> callback;
